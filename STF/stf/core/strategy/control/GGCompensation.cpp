 ...
 * A control block that calculates the gravity tilt torque and outputs the torque with the opposite sign
 *
 * @author Taiga Nomi
 * @date   2011.02.16
 */
...
void GGCompensation::do_compute(const datatype::Time& t) {
	...
	//Calculates the Earth direction vector in body coordinates from orbit information and attitude information
	...
	//Output torque that cancels gravity tilt torque
